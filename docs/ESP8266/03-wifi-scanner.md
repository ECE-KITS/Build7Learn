...
### Result
The Serial Monitor displays a list of all nearby WiFi networks (SSIDs) and their signal strength (RSSI) every 5 seconds.

### Reason
The WiFi.scanNetworks() function utilizes the ESP8266's RF hardware to cycle through standard 2.4GHz WiFi channels, listening for beacon frames broadcast by routers.